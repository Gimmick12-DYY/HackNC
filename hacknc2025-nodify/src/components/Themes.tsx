...
const MORANDI_THEME: ThemeDefinition = {
  ...
  node: {
    ...
    shadow: {
      default: "0 10px 24px rgba(56, 65, 60, 0.28)",
      highlight: "0 0 34px rgba(127, 178, 125, 0.55)",
    },
    highlightStroke: "#7fb27d",
    minimizedPalette: [
      "#7fb27d",
      "#d79a43",
      "#5aa7a0",
    ...
    opacityLevels: { 0: 1, 1: 0.95, 2: 0.82, 3: 0.68, default: 0.56 },
  },
  lines: {
    default: { stroke: "rgba(122, 162, 120, 0.55)" },
    connected: { stroke: "rgba(127, 178, 125, 0.95)" },
    dimmed: { stroke: "rgba(122, 162, 120, 0.28)" },
    preview: { stroke: "rgba(127, 178, 125, 0.65)", opacity: 0.75 },
  },
  ui: {
    header: {
